(() => {
  ...
  function setDownloadLocked() {
    ...
    if (copy) copy.textContent = "Complete your purchase to unlock the CREATOR ARSENAL 1000 ZIP download.";
  }
  ...
  function setBuyState(ready) {
    ...
    button.textContent = ready ? "Buy CREATOR ARSENAL 1000 ↗" : "Preparing checkout…";
  ...
  ["#downloadVault", "#downloadPersistent"].forEach(selector => {
    $(selector)?.addEventListener("click", async event => {
      ...
      try {
        ...
        link.textContent = "Download CREATOR ARSENAL 1000 ↗";
      }
    });
  });

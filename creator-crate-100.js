(() => {
  ...
  const product = (cfg.products || []).find(p => p.id === "creator-crate-100");
  ...
  const storageKey = "dewify:download-ready:creator-crate-100:" + deviceId;
  const progressKey = "dewify:progress:creator-crate-100:" + deviceId;
  const downloadFilename = "CREATOR CRATE 100.zip";
  ...
  function setDownloadLocked() {
    ...
    if (copy) copy.textContent = "Complete your purchase to unlock the CREATOR CRATE 100 ZIP download.";
  }
  ...
  function setDownloadLink() {
    ...
    if (title) title.textContent = "Your CREATOR CRATE 100 ZIP is ready.";
  ...
  function setBuyState(ready) {
    ...
    button.textContent = ready ? "Buy CREATOR CRATE 100 ↗" : "Preparing checkout…";
  ...
  ["#downloadVault", "#downloadPersistent"].forEach(selector => {
    $(selector)?.addEventListener("click", async event => {
      ...
      try {
        ...
        link.textContent = "Download CREATOR CRATE 100 ↗";
      }
    });
  });

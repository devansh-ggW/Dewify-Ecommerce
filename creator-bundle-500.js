(() => {
  ...
  const product = (cfg.products || []).find(p => p.id === "creator-bundle-500");
  ...
  const storageKey = "dewify:download-ready:creator-bundle-500:" + deviceId;
  const progressKey = "dewify:progress:creator-bundle-500:" + deviceId;
  const downloadFilename = "CREATOR BUNDLE 500.zip";
  ...
  function setDownloadLocked() {
    ...
    if (copy) copy.textContent = "Complete your purchase to unlock the CREATOR BUNDLE 500 ZIP download.";
  }
  ...
  function setDownloadLink() {
    ...
    if (title) title.textContent = "Your CREATOR BUNDLE 500 ZIP is ready.";
  ...
  function setBuyState(ready) {
    ...
    button.textContent = ready ? "Buy CREATOR BUNDLE 500 ↗" : "Preparing checkout…";
  ...
  ["#downloadVault", "#downloadPersistent"].forEach(selector => {
    $(selector)?.addEventListener("click", async event => {
      ...
      try {
        ...
        link.textContent = "Download CREATOR BUNDLE 500 ↗";
      }
    });
  });
